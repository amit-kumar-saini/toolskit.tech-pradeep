      ...
      <div className="container">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight animate-slide-up">
            All Your <span className="gradient-text">Digital Tools</span>
            <br />
            In One Place
          </h1>

          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: "0.1s" }}>
            Convert PDFs, compress images, remove backgrounds, calculate age &amp; more. Fast, free, and no signup required.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            ...
            <Button variant="glass" size="xl" asChild>
              <Link to="/about">Learn More About ToolsKit</Link>
            </Button>
          </div>
